...
export function KpiCard({
  ...
  return (
    <Card
      ...
      className="animate-rise group relative flex flex-col p-3"
    >
      ...
      <div className="relative">
        <p className="truncate text-[11px] font-medium tracking-wide text-[var(--color-ink-soft)]">
          {kpi.label}
        </p>

        <p className="mt-1 text-[1.5rem] font-bold leading-[1.05] tracking-[-0.02em] text-[var(--color-ink)]">
        ...
        {fraction !== undefined ? (
          <div className="mt-2 h-1 w-full overflow-hidden rounded-full bg-[var(--color-surface-sunken)]">
            <div
